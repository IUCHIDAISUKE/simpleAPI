...
func (h *coastersHandlers) coaster(w http.ResponseWriter, r *http.Request) {
	switch r.Method {
	case "GET":
		h.get(w, r)
		return
...
func (a adminPortal) handler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte("<html><h1>Super secret portal</h1></html>"))
...
func main() {
	...
	http.HandleFunc("/coasters", coastersHandlers.coaster)
